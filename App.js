...
//        app.grid.add(tip);
    ...
    readObject : function(object) {
        ...
        if (_.isNull(object)){
            ...
            if (!_.isUndefined(obj)&&!_.isNull(obj)) {
                ...
                app.cache.push({object : object, promise: deferred});
                return deferred.promise;
           }
       }
   },
   ...
   recurseUpObject : function( obj ) {
        ...
        var parentItem = function(obj,callback) {
            ...
            switch(type) {
                case 'task' : parentAttr = 'WorkProduct'; break;
                case 'defect' : parentAttr = 'Requirement'; break;
                case 'hierarchicalrequirement' : parentAttr = ( !_.isNull(obj.get("Parent")) ? "Parent" : "PortfolioItem" ); break;
                case 'portfolioitem' : parentAttr = 'Parent'; break;
            }
